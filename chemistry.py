...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for element in symbol_quantity_list:
        sym = element[0]
        quantity = element[1]
        mass = periodic_table_dict[sym][1]
        mass_total = mass * quantity
        stored_values += mass_total
...
def main(user_info):
    user_info = input("Type in an element: ")
    sqlist = parse_formula(user_info, make_perodic_table())
    print(compute_molar_mass(sqlist, make_perodic_table()))
    return 
